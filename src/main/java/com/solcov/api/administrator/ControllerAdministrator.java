...
public class ControllerAdministrator {
    ...
    @Autowired
    private IRepositoryAdministrator repositoryAdministrator;
    ...
    public Map<String, String> login(@RequestParam("username") String username, @RequestParam("password") String password) {
        ...
        List<Administrator> lstAdminExist = repositoryAdministrator.findByUsername(username);
        HashMap<String, String> map = new HashMap<>();
        System.out.println(sha256pass);
        System.out.println(lstAdminExist.get(0).getPassword());
